...
data_1 = np.loadtxt("figure_S16-d_NaNbO2F2_data.txt", skiprows=1)
data_2 = np.loadtxt("figure_S16-d_NaTaO2F2_data.txt", skiprows=1)
...
# DATA N°2
axis2.set_ylim(0.08, 0.12)
axis2.set_xlim(15, 310)
axis22.set_ylim(0.08, 0.12)
...
# DATA n°2
axis2.plot([25, 220, 220], [0.095, 0.095, 0.102], '--', color='b', linewidth=1)
axis22.plot([25, 220, 220], [0.105, 0.105, 0.103], '--', color='b', linewidth=1)

# Rectangles and texts

# DATA n°2
rect_2 = mpatches.Rectangle((150, 0.092), 70, 0.0025, alpha=0.25, facecolor='b')
rect_3 = mpatches.Rectangle((150, 0.1055), 70, 0.0025, alpha=0.25, facecolor='b')
axis2.add_patch(rect_2)
axis22.add_patch(rect_3)
axis2.text(155, 0.0925, '~0.003', fontsize=16, color='b')
axis22.text(155, 0.106, '~0.010', fontsize=16, color='b')
...
fig.savefig('figure_S16-d.png', dpi=300, bbox_inches='tight')
plt.show()
