...
data_1 = np.loadtxt("figure_S16-c_NaNbO2F2_data.txt", skiprows = 1)
data_2 = np.loadtxt("figure_S16-c_NaTaO2F2_data.txt", skiprows = 1)
...
# DATA n°1
ax00.set_ylim(2.15, 2.35)
ax10.set_ylim(2.35, 2.55)
ax20.set_ylim(2.70, 2.90)
ax30.set_ylim(2.20, 2.40)

# DATA n°2
ax01.set_ylim(2.05, 2.25)
ax11.set_ylim(2.20, 2.40)
ax21.set_ylim(2.50, 2.70)
ax31.set_ylim(2.15, 2.35)
...
axis[0, 0].set_ylim(2.15, 2.35)
axis[1, 0].set_ylim(2.35, 2.55)
axis[2, 0].set_ylim(2.70, 2.90)
axis[3, 0].set_ylim(2.20, 2.40)

# DATA n°2
axis[0, 1].set_ylim(2.05, 2.25)
axis[1, 1].set_ylim(2.20, 2.40)
axis[2, 1].set_ylim(2.50, 2.70)
axis[3, 1].set_ylim(2.15, 2.35)
...
axis[0, 0].set_ylabel(r"Na–F1 ($\AA$)", fontsize = 18)
axis[1, 0].set_ylabel(r"Na–F1' ($\AA$)", fontsize = 18)
axis[2, 0].set_ylabel(r"Na–F1'' ($\AA$)", fontsize = 18)
axis[3, 0].set_ylabel(r'Na–F2 ($\AA$)', fontsize = 18)
...
axis[0, 1].set_ylabel(r'Na–F1 ($\AA$)', fontsize = 18)
axis[1, 1].set_ylabel(r"Na–F1' ($\AA$)", fontsize = 18)
axis[2, 1].set_ylabel(r"Na–F1'' ($\AA$)", fontsize = 18)
axis[3, 1].set_ylabel(r'Na–F2 ($\AA$)', fontsize = 18)
...
axis[0, 1].yaxis.set_minor_locator(MultipleLocator(.01))
...
axis[1, 1].yaxis.set_minor_locator(MultipleLocator(.01))
...
axis[2, 1].yaxis.set_minor_locator(MultipleLocator(.01))
...
axis[3, 1].yaxis.set_minor_locator(MultipleLocator(.01))
...
# DATA n°1
axis[0, 0].plot([25, 220, 220], [2.25, 2.25, 2.22], '--', color='b', linewidth=1)
axis[1, 0].plot([25, 220, 220], [2.37, 2.37, 2.46], '--', color='b', linewidth=1)
axis[2, 0].plot([25, 220, 220], [2.87, 2.87, 2.82], '--', color='b', linewidth=1)
axis[3, 0].plot([25, 220, 220], [2.23, 2.23, 2.30], '--', color='b', linewidth=1)

# DATA n°2
axis[0, 1].plot([25, 220, 220], [2.20, 2.20, 2.16], '--', color='b', linewidth=1)
axis[1, 1].plot([25, 220, 220], [2.24, 2.24, 2.30], '--', color='b', linewidth=1)

# Rectangles and texts
rect_1 = mpatches.Rectangle((140, 2.26), 80, 0.025, alpha=0.25, facecolor='b')
rect_2 = mpatches.Rectangle((140, 2.37), 80, 0.025, alpha=0.25, facecolor='b')
rect_3 = mpatches.Rectangle((140, 2.77), 80, 0.025, alpha=0.25, facecolor='b')
rect_4 = mpatches.Rectangle((140, 2.33), 80, 0.025, alpha=0.25, facecolor='b')
rect_5 = mpatches.Rectangle((140, 2.10), 80, 0.025, alpha=0.25, facecolor='b')
rect_6 = mpatches.Rectangle((140, 2.35), 80, 0.025, alpha=0.25, facecolor='b')
axis[0, 0].add_patch(rect_1)
axis[1, 0].add_patch(rect_2)
axis[2, 0].add_patch(rect_3)
axis[3, 0].add_patch(rect_4)
axis[0, 1].add_patch(rect_5)
axis[1, 1].add_patch(rect_6)
axis[0, 0].text(145, 2.265, '~0.03 $\AA$', fontsize=16, color='b')
axis[1, 0].text(145, 2.375, '~0.09 $\AA$', fontsize=16, color='b')
axis[2, 0].text(145, 2.775, '~0.03 $\AA$', fontsize=16, color='b')
axis[3, 0].text(145, 2.335, '~0.07 $\AA$', fontsize=16, color='b')
axis[0, 1].text(145, 2.105, '~0.03 $\AA$', fontsize=16, color='b')
axis[1, 1].text(145, 2.355, '~0.06 $\AA$', fontsize=16, color='b')

f.savefig('figure_S16-c.png', dpi=300, bbox_inches='tight')
plt.show()
