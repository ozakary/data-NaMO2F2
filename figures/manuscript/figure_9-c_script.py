...
data_1 = np.loadtxt("figure_9-c_NaNbO2F2_data.txt", skiprows = 1)
data_2 = np.loadtxt("figure_9-c_NaTaO2F2_data.txt", skiprows = 1)
...
# DATA n°1
ax00.set_ylim(1.85, 2.1)
ax10.set_ylim(1.800, 2.05)
ax20.set_ylim(88, 93)
ax30.set_ylim(99, 104)

# DATA n°2
ax01.set_ylim(2, 2.25)
ax11.set_ylim(1.8, 2.05)
ax21.set_ylim(76, 81)
...
ax20.yaxis.set_minor_locator(MultipleLocator(.2))
...
ax21.yaxis.set_minor_locator(MultipleLocator(.2))
...
axis[0, 0].set_ylim(1.8, 2.05)
axis[1, 0].set_ylim(1.95, 2.20)
axis[2, 0].set_ylim(1.85, 2.1)
axis[3, 0].set_ylim(1.85, 2.1)

# DATA n°2
axis[0, 1].set_ylim(1.8, 2.05)
axis[1, 1].set_ylim(1.95, 2.20)
axis[2, 1].set_ylim(1.7, 1.95)
axis[3, 1].set_ylim(1.95, 2.2)
...
axis[0, 0].set_ylabel(r"Nb–O1 ($\AA$)", fontsize = 18)
axis[1, 0].set_ylabel(r"Nb–O1' ($\AA$)", fontsize = 18)
axis[2, 0].set_ylabel(r"Nb–O2 ($\AA$)", fontsize = 18)
axis[3, 0].set_ylabel(r"Nb–F2 ($\AA$)", fontsize = 18)
...
axis[0, 1].set_ylabel(r"Ta–O1 ($\AA$)", fontsize = 18)
axis[1, 1].set_ylabel(r"Ta–O1' ($\AA$)", fontsize = 18)
axis[2, 1].set_ylabel(r"Ta–O2 ($\AA$)", fontsize = 18)
axis[3, 1].set_ylabel(r"Ta–F2 ($\AA$)", fontsize = 18)
...
axis[2, 0].yaxis.set_minor_locator(MultipleLocator(.2))
...
axis[2, 1].yaxis.set_minor_locator(MultipleLocator(.2))
...
# DATA n°1
axis[0, 0].plot([25, 220, 220], [1.955, 1.955, 1.85], '--', color='b', linewidth=1)
axis[1, 0].plot([25, 220, 220], [2.02, 2.02, 2.10], '--', color='b', linewidth=1)
axis[3, 0].plot([25, 220, 220], [2.00, 2.00, 1.98], '--', color='b', linewidth=1)


# DATA n°2
axis[0, 1].plot([25, 220, 220], [1.955, 1.955, 1.92], '--', color='b', linewidth=1)
axis[1, 1].plot([25, 220, 220], [2.04, 2.04, 2.09], '--', color='b', linewidth=1)
axis[2, 1].plot([25, 220, 220], [1.85, 1.85, 1.79], '--', color='b', linewidth=1)
axis[3, 1].plot([25, 220, 220], [2.07, 2.07, 2.09], '--', color='b', linewidth=1)


# Rectangles and texts
rect_1 = mpatches.Rectangle((140, 1.97), 80, 0.03, alpha=0.25, facecolor='b')
rect_2 = mpatches.Rectangle((140, 1.97), 80, 0.03, alpha=0.25, facecolor='b')
rect_3 = mpatches.Rectangle((140, 1.98), 80, 0.03, alpha=0.25, facecolor='b')
rect_4 = mpatches.Rectangle((140, 2), 80, 0.03, alpha=0.25, facecolor='b')
rect_5 = mpatches.Rectangle((140, 1.86), 80, 0.03, alpha=0.25, facecolor='b')
rect_6 = mpatches.Rectangle((140, 2.02), 80, 0.03, alpha=0.25, facecolor='b')
rect_7 = mpatches.Rectangle((140, 2.02), 80, 0.03, alpha=0.25, facecolor='b')



axis[0, 0].add_patch(rect_1)
axis[0, 1].add_patch(rect_2)
axis[1, 0].add_patch(rect_3)
axis[1, 1].add_patch(rect_4)
axis[2, 1].add_patch(rect_5)
axis[3, 0].add_patch(rect_6)
axis[3, 1].add_patch(rect_7)


axis[0, 0].text(145, 1.975, '~0.11 $\AA$', fontsize=16, color='b')
axis[0, 1].text(145, 1.975, '~0.04 $\AA$', fontsize=16, color='b')
axis[1, 0].text(145, 1.985, '~0.09 $\AA$', fontsize=16, color='b')
axis[1, 1].text(145, 2.005, '~0.05 $\AA$', fontsize=16, color='b')
axis[2, 1].text(145, 1.865, '~0.06 $\AA$', fontsize=16, color='b')
axis[3, 0].text(145, 2.025, '~0.02 $\AA$', fontsize=16, color='b')
axis[3, 1].text(145, 2.025, '~0.02 $\AA$', fontsize=16, color='b')


f.savefig('figure_9-c.png', dpi=300, bbox_inches='tight')
plt.show()
