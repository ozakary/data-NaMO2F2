...
data_1 = np.loadtxt("figure_S6_data.txt", skiprows = 1, usecols=(1, 2))
...
ax.text(x = 150, y = -30, s = text[0] + "$= {m:.3f}$".format(m=m11) + '$(1)$ ' + text[1] + ' $+$ ' + "${b:.1f}$".format(b=b11) + '$(2)$', color = 'r', fontsize = 14)
...
fig.savefig('figure_S6.png', dpi=300, bbox_inches='tight')
plt.show()
