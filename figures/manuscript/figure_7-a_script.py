...
#axis1.set_title('(a)', color = 'k', fontsize=16, x = 0, y = 1.15)
...
axis1.text(32.56, 220, '(020)', fontsize=12, color='r')
axis1.text(33.20, 225, '(112)', fontsize=12, color='r')

axis1.text(33.75, 250, r'($\overline{2}$12)', fontsize=12, color='r', fontname = "Times New Roman")
axis1.text(34.45, 125, '(300)', fontsize=12, color='r')
axis1.text(34.4, 175, '(120)', fontsize=12, color='r')

# Add an arrow pointing to a certain point in the left plot
x_highlight1 = 32.72
y_highlight1 = 260
axis1.arrow(x_highlight1 - 0.05, y_highlight1 - 20, 0.1, 30,
          head_width=0.03, head_length=10, fc='r', ec='r')
axis1.arrow(x_highlight1 - 0.05, y_highlight1 - 20, 0.16, 28,
          head_width=0.03, head_length=10, fc='r', ec='r')

x_highlight2 = 33.35
y_highlight2 = 265
axis1.arrow(x_highlight2 - 0.05, y_highlight2 - 20, -0.17, 30,
          head_width=0.03, head_length=10, fc='r', ec='r')
axis1.arrow(x_highlight2 - 0.05, y_highlight2 - 20, -0.23, 28,
          head_width=0.03, head_length=10, fc='r', ec='r')
...
x_highlight2 = 34.65
y_highlight2 = 135
axis1.arrow(x_highlight2 - 0.05, y_highlight2 - 20, -0.16, -30,
          head_width=0.03, head_length=10, fc='r', ec='r')
axis1.arrow(x_highlight2 - 0.05, y_highlight2 - 20, -0.22, -28,
          head_width=0.03, head_length=10, fc='r', ec='r')

x_highlight2 = 34.6
y_highlight2 = 215
axis1.arrow(x_highlight2 - 0.05, y_highlight2 - 20, 0.22, 30,
          head_width=0.03, head_length=10, fc='r', ec='r')
axis1.arrow(x_highlight2 - 0.05, y_highlight2 - 20, 0.28, 28,
          head_width=0.03, head_length=10, fc='r', ec='r')

fig.savefig('figure_7-a.png', dpi=600, bbox_inches='tight')
plt.show()
