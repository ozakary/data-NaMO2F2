...
data_1 = np.loadtxt("figure_S7_top-right_data.txt", skiprows=1, encoding = "utf-16") # the encoding to read the data files!!!
...
plt.tight_layout()
fig1.savefig('figure_S7_top-right.png', dpi=300, bbox_inches='tight')
plt.show()
