...
data_1 = np.loadtxt("figure_S19_NaNbO2F2_data.txt", skiprows = 1)
data_2 = np.loadtxt("figure_S19_NaTaO2F2_data.txt", skiprows = 1)
...
# DATA n°1
ax00.set_ylim(70, 85)
ax10.set_ylim(72.5, 87.5)
ax20.set_ylim(72.5, 87.5)
ax30.set_ylim(160, 175)

# DATA n°2
ax01.set_ylim(75, 90)
ax11.set_ylim(72.5, 87.5)
ax21.set_ylim(72.5, 87.5)
ax31.set_ylim(170, 185)
...
ax30.yaxis.set_minor_locator(MultipleLocator(.5))
...
ax31.yaxis.set_minor_locator(MultipleLocator(.5))
...
axis[0, 0].set_ylim(72.5, 87.5)
axis[1, 0].set_ylim(70, 85)
axis[2, 0].set_ylim(95, 110)
axis[3, 0].set_ylim(90, 105)

# DATA n°2
axis[0, 1].set_ylim(72.5, 87.5)
axis[1, 1].set_ylim(70, 85)
axis[2, 1].set_ylim(95, 110)
axis[3, 1].set_ylim(90, 105)
...
axis[0, 0].set_ylabel(r"F1–Nb–F2 (°)", fontsize = 18)
axis[1, 0].set_ylabel(r"F1–Nb–O2 (°)", fontsize = 18)
axis[2, 0].set_ylabel(r"F2–Nb–O2' (°)", fontsize = 18)
axis[3, 0].set_ylabel(r"O2–Nb–O2' (°)", fontsize = 18)
...
axis[0, 1].set_ylabel(r"F1–Ta–F2 (°)", fontsize = 18)
axis[1, 1].set_ylabel(r"F1–Ta–O2 (°)", fontsize = 18)
axis[2, 1].set_ylabel(r"F2–Ta–O2' (°)", fontsize = 18)
axis[3, 1].set_ylabel(r"O2–Ta–O2' (°)", fontsize = 18)
...
axis[3, 0].yaxis.set_minor_locator(MultipleLocator(.5))
...
axis[3, 1].yaxis.set_minor_locator(MultipleLocator(.5))
...
# DATA n°1
axis[1, 0].plot([25, 220, 220], [76.5, 76.5, 78.4], '--', color='b', linewidth=1)

# DATA n°2
axis[1, 1].plot([25, 220, 220], [77.4, 77.4, 82.3], '--', color='b', linewidth=1)
axis[2, 1].plot([25, 220, 220], [103, 103, 99], '--', color='b', linewidth=1)


# Rectangles and texts
rect_1 = mpatches.Rectangle((160, 74.5), 60, 1.5, alpha=0.25, facecolor='b')
rect_2 = mpatches.Rectangle((160, 75.5), 60, 1.5, alpha=0.25, facecolor='b')
rect_3 = mpatches.Rectangle((160, 103.5), 60, 1.5, alpha=0.25, facecolor='b')


axis[1, 0].add_patch(rect_1)
axis[1, 1].add_patch(rect_2)
axis[2, 1].add_patch(rect_3)


axis[1, 0].text(165, 74.8, '~1.8°', fontsize=16, color='b')
axis[1, 1].text(165, 75.8, '~4.9°', fontsize=16, color='b')
axis[2, 1].text(165, 103.8, '~3.9°', fontsize=16, color='b')


f.savefig('figure_S19.png', dpi=300, bbox_inches='tight')
plt.show()
