...
data_1 = np.loadtxt("figure_S21_NaNbO2F2_data.txt", skiprows = 1)
data_2 = np.loadtxt("figure_S21_NaTaO2F2_data.txt", skiprows = 1)
...
# DATA n°1
ax00.set_ylim(87.5, 102.5)
ax10.set_ylim(82.5, 97.5)
ax20.set_ylim(160, 175)
ax30.set_ylim(150, 165)

# DATA n°2
ax01.set_ylim(90, 105)
ax11.set_ylim(77.5, 92.5)
ax21.set_ylim(147.5, 162.5)
ax31.set_ylim(155, 170)
...
axis[1, 0].set_ylim(75, 90)
axis[2, 0].set_ylim(85, 100)
axis[3, 0].set_ylim(80, 95)
...
# DATA n°1
axis[0, 0].plot([25, 220, 220], [80.4, 80.4, 79.0], '--', color='b', linewidth=1)

# DATA n°2
axis[0, 1].plot([25, 220, 220], [82.1, 82.1, 80.4], '--', color='b', linewidth=1)

# Rectangles and texts
rect_1 = mpatches.Rectangle((160, 81), 60, 1.5, alpha=0.25, facecolor='b')
rect_2 = mpatches.Rectangle((160, 82.5), 60, 1.5, alpha=0.25, facecolor='b')

axis[0, 0].add_patch(rect_1)
axis[0, 1].add_patch(rect_2)

axis[0, 0].text(165, 81.3, '~1.3°', fontsize=16, color='b')
axis[0, 1].text(165, 82.8, '~1.7°', fontsize=16, color='b')

f.savefig('figure_S21.png', dpi=300, bbox_inches='tight')
plt.show()
