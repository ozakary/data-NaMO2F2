...
data_1 = np.loadtxt("figure_S17_NaNbO2F2_data.txt", skiprows = 1)
data_2 = np.loadtxt("figure_S17_NaTaO2F2_data.txt", skiprows = 1)
...
# DATA n°1
ax00.set_ylim(2.20, 2.60)
ax10.set_ylim(2.80, 3.20)
ax20.set_ylim(2.30, 2.70)
ax30.set_ylim(2.70, 3.10)

# DATA n°2
ax01.set_ylim(2.20, 2.60)
ax11.set_ylim(2.60, 3.00)
ax21.set_ylim(2.20, 2.60)
ax31.set_ylim(3.00, 3.40)
...
axis[0, 0].set_ylim(2.20, 2.60)
axis[1, 0].set_ylim(2.80, 3.20)
axis[2, 0].set_ylim(2.30, 2.70)
axis[3, 0].set_ylim(2.70, 3.10)

# DATA n°2
axis[0, 1].set_ylim(2.20, 2.60)
axis[1, 1].set_ylim(2.60, 3.00)
axis[2, 1].set_ylim(2.20, 2.60)
axis[3, 1].set_ylim(3.00, 3.40)
...
axis[0, 0].set_ylabel(r"Na–F2' ($\AA$)", fontsize = 18)
axis[1, 0].set_ylabel(r"Na–F2'' ($\AA$)", fontsize = 18)
axis[2, 0].set_ylabel(r'Na–O1 ($\AA$)', fontsize = 18)
axis[3, 0].set_ylabel(r'Na–O2 ($\AA$)', fontsize = 18)
...
axis[0, 1].set_ylabel(r"Na–F2' ($\AA$)", fontsize = 18)
axis[1, 1].set_ylabel(r"Na–F2'' ($\AA$)", fontsize = 18)
axis[2, 1].set_ylabel(r'Na–O1 ($\AA$)', fontsize = 18)
axis[3, 1].set_ylabel(r'Na–O2 ($\AA$)', fontsize = 18)
...
axis[0, 1].yaxis.set_minor_locator(MultipleLocator(.02))
...
axis[1, 1].yaxis.set_minor_locator(MultipleLocator(.02))
...
axis[2, 1].yaxis.set_minor_locator(MultipleLocator(.02))
...
axis[3, 1].yaxis.set_minor_locator(MultipleLocator(.02))
...
# DATA n°1
axis[2, 0].plot([25, 220, 220], [2.45, 2.45, 2.55], '--', color='b', linewidth=1)
axis[3, 0].plot([25, 220, 220], [2.81, 2.81, 2.98], '--', color='b', linewidth=1)

# DATA n°2
axis[2, 1].plot([25, 220, 220], [2.36, 2.36, 2.42], '--', color='b', linewidth=1)
axis[3, 1].plot([25, 220, 220], [3.06, 3.06, 3.26], '--', color='b', linewidth=1)

# # Rectangles and texts
rect_1 = mpatches.Rectangle((140, 2.39), 80, 0.05, alpha=0.25, facecolor='b')
rect_2 = mpatches.Rectangle((140, 2.75), 80, 0.05, alpha=0.25, facecolor='b')
rect_3 = mpatches.Rectangle((140, 2.30), 80, 0.05, alpha=0.25, facecolor='b')
rect_4 = mpatches.Rectangle((140, 3.07), 80, 0.05, alpha=0.25, facecolor='b')
axis[2, 0].add_patch(rect_1)
axis[3, 0].add_patch(rect_2)
axis[2, 1].add_patch(rect_3)
axis[3, 1].add_patch(rect_4)
axis[2, 0].text(145, 2.398, '~0.1 $\AA$', fontsize=16, color='b')
axis[3, 0].text(145, 2.758, '~0.17 $\AA$', fontsize=16, color='b')
axis[2, 1].text(145, 2.308, '~0.06 $\AA$', fontsize=16, color='b')
axis[3, 1].text(145, 3.078, '~0.2 $\AA$', fontsize=16, color='b')

f.savefig('figure_S17.png', dpi=300, bbox_inches='tight')
plt.show()
