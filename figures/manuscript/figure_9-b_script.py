...
data_1 = np.loadtxt("figure_9-b_NaNbO2F2_data.txt", skiprows=1)
data_2 = np.loadtxt("figure_9-b_NaTaO2F2_data.txt", skiprows=1)
...
# DATA n°2
axis2.plot([25, 220, 220], [10.65, 10.65, 10.5], '--', color='b', linewidth=1)
axis22.plot([25, 220, 220], [10.15, 10.15, 10], '--', color='b', linewidth=1)

# Rectangles and texts

# DATA n°2
rect_2 = mpatches.Rectangle((150, 10.8), 70, 0.25, alpha=0.25, facecolor='b')
rect_3 = mpatches.Rectangle((150, 9.5), 70, 0.25, alpha=0.25, facecolor='b')
axis2.add_patch(rect_2)
axis22.add_patch(rect_3)
axis2.text(150, 10.85, '~0.1 $\AA^3$', fontsize=16, color='b')
axis22.text(150, 9.55, '~0.2 $\AA^3$', fontsize=16, color='b')
...
fig.savefig('figure_9-b.png', dpi=300, bbox_inches='tight')
plt.show()
